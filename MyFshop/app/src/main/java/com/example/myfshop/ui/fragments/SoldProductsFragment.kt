...
//    }
//
//    // Gọi hàm getSoldProductsList() để lấy danh sách sản phẩm bán được
//    private fun getSoldProductsList() {
//        showProgressDialog(resources.getString(R.string.please_wait)) // Hiển thị loading
//        FirestoreClass().getSoldProductsList(this@SoldProductsFragment) // Sử dụng FirestoreClass để lấy dữ liệu
//    }
//
//    // Hàm này sẽ được gọi khi lấy danh sách sản phẩm bán được thành công
//    fun successSoldProductsList(soldProductsList: ArrayList<SoldProduct>) {
//        hideProgressDialog() // Ẩn loading
//
//        if (_rootView == null) {
//            return
//        }
...
//    }
//
//    // Hàm này sẽ được gọi khi có lỗi khi lấy dữ liệu
//    fun errorGettingSoldProductsList() {
//        hideProgressDialog()
//        Log.e("Firestore Error", "Error while getting sold products list.")
//    }
//
//    override fun onDestroyView() {
//        super.onDestroyView()
